...
export function AccountPage({ user, accordions, selectedAccordionId, instrumentType, onInstrumentChange, onUserUpdated, onOpenSettings, onLogout, onAccountDeleted }: AccountPageProps) {
    ...
    <main className="page-content account-page">
      ...
      <div className="account-layout">
        ...
        <aside className="account-sidebar">
          <section className="account-card"><header><span><Music2 /></span><div><h2>Instrument appris</h2><p>Change de parcours sans perdre tes données.</p></div></header><div className="profile-instrument"><button type="button" className={instrumentType === 'accordion' ? 'is-selected' : ''} onClick={() => onInstrumentChange('accordion')}>Accordéon</button><button type="button" className={instrumentType === 'piano' ? 'is-selected' : ''} onClick={() => onInstrumentChange('piano')}>Piano</button></div></section>
