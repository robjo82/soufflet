...
import type { AccordionConfig, LeftHandAcousticProfile, PianoConfig, UserAccount } from '../types';
...
export function AccountPage({ user, accordions, selectedAccordionId, pianos = [], selectedPianoId, onUserUpdated, onOpenSettings, onLogout, onAccountDeleted }: AccountPageProps) {
