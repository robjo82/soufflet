...
import { AlertTriangle, Check, ChevronRight, Copy, Eye, EyeOff, KeyRound, Mic2, Palette, Save, ShieldCheck, SlidersHorizontal, Sparkles, TimerReset, Volume2, X } from 'lucide-react';
