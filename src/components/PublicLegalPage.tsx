...
function PrivacyPolicy() {
  return (
    <>
      ...
      <p className="legal-date">Dernière mise à jour : 2 août 2026</p>
      ...
      <section><h2>Données enregistrées</h2><ul><li>adresse e-mail, nom affiché et mot de passe conservé uniquement sous forme hachée ;</li><li>accordéons personnels, notation et préférences d’apprentissage ;</li><li>séances, durée active et compteurs de résultats séparés pour la main droite, la main gauche et leur coordination ;</li><li>mesures d’accordeur explicitement validées : note, fréquence, écart en cents, confiance, bouton et direction ;</li><li>profils main gauche : classes harmoniques normalisées, résultat, confiance, bouton et direction ;</li><li>cookie de session sécurisé nécessaire à la connexion, valable au maximum 30 jours.</li></ul></section>
      <section><h2>Microphone et fichiers musicaux</h2><p>Le microphone est analysé localement dans le navigateur pendant les exercices : aucun enregistrement sonore n’est envoyé ni conservé. Dans l’accordeur, seules les mesures numériques que l’utilisateur valide sont enregistrées avec son compte. Un scan main gauche conserve douze coefficients harmoniques normalisés par geste, ainsi que le résultat et sa confiance ; ce profil compact ne permet pas de reconstruire le son. Lorsqu’un utilisateur demande explicitement une transcription, le fichier fourni peut être transmis temporairement au service Google Gemini pour réaliser cette analyse. Il n’est pas ajouté à la bibliothèque commune et Soufflet ne le conserve pas après le traitement.</p></section>
