...
function PrivacyPolicy() {
  return (
    <>
      ...
      <p className="legal-date">Dernière mise à jour : 16 juillet 2026</p>
      ...
      <section><h2>Données enregistrées</h2><ul><li>adresse e-mail, nom affiché et mot de passe conservé uniquement sous forme hachée ;</li><li>accordéons personnels, notation et préférences d’apprentissage ;</li><li>séances, durée active, résultats rythmiques et notes évaluées ;</li><li>cookie de session sécurisé nécessaire à la connexion, valable au maximum 30 jours.</li></ul></section>
      <section><h2>Microphone et fichiers musicaux</h2><p>Le microphone est analysé localement dans le navigateur pendant les exercices : aucun enregistrement sonore n’est envoyé ni conservé. Lorsqu’un utilisateur demande explicitement une transcription, le fichier fourni peut être transmis temporairement au service Google Gemini pour réaliser cette analyse. Il n’est pas ajouté à la bibliothèque commune et Soufflet ne le conserve pas après le traitement.</p></section>
