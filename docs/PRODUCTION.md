...
- accordeur monophonique des touches mélodiques, analyse harmonique basses/accords, scan main gauche synchronisé et détecteur d’entraînement séparant droite, gauche et coordination des attaques ;
